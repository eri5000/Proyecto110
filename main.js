//https://teachablemachine.withgoogle.com/models/t3ykLhsWX/
...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/t3ykLhsWX/model.json',modelLoaded);
...
function gotResult(error,results){
  if(error){
      ...
      if(results[1].label == "sorprendido"){
          document.getElementById("update_emoji2").innerHTML = "&#65039";
  }}
}
